...
<table class="floatTable" align="center" bgcolor="#e3e3e3" border="0" cellpadding="5" cellspacing="1" width="100%">
        ...
        <?php if(is_array($kache)): foreach($kache as $id=>$k): ?><tr>
			...
			<td align="center" bgcolor="#ffffff"><?php echo ($k['num']); ?></td>
			<td class="price" align="center" bgcolor="#ffffff">￥<?php echo ($k['num'] * $k['shop_price']); ?>元</td>
			</tr><?php endforeach; endif; ?>
			<tr>
			<td colspan="7" class="f1 f14b" style="text-align:right;" bgcolor="#ffffff">
						购物金额小计 ￥<?php echo ($shop_total); ?>元，比市场价 ￥<?php echo ($market_total); ?>元 节省了 ￥<?php echo ($market_total - $shop_total); ?>元 (<?php echo round(($shop_total / $market_total * 100) , 2);?>%)			</td>
			</tr>
			</tbody></table>
	<div class="goodsTitle clearfix" style="background:#f6f6f6; border:#E3E3E3 solid 1px; border-bottom:none;">
...
<div class="goodsTitle" style="background:#f6f6f6; border:#E3E3E3 solid 1px; border-bottom:none;">费用总计</div>
	...
	<table class="floatTable" align="center" bgcolor="#e3e3e3" border="0" cellpadding="5" cellspacing="1" width="100%">
	    <tbody>
		    ...
		    <tr>
		    <td align="right" bgcolor="#ffffff">
		      商品总价: <font class="f1 f14b">￥<?php echo ($shop_total); ?>元</font>
		    </td>
		    </tr>
		    <tr>
		    <td align="right" bgcolor="#ffffff"> 应付款金额: <font class="f1 f14b">￥<?php echo ($shop_total); ?>元</font>
		    </td>
		  </tr>
		</tbody>
	</table>
