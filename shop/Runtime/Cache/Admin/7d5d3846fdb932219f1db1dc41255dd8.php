          ...
          <tr>
            ...
            <td><select name="cat_id"  >
              <?php if(is_array($catlist)): foreach($catlist as $key=>$cat): ?><option value="<?php echo ($cat["cat_id"]); ?>">
                <?php $__FOR_START_13289__=0;$__FOR_END_13289__=$cat['lv'];for($i=$__FOR_START_13289__;$i < $__FOR_END_13289__;$i+=1){ ?>&nbsp;&nbsp;<?php } echo ($cat["cat_name"]); ?></option><?php endforeach; endif; ?>
            </select>
             </td>
          </tr>
          <tr>
