...
<div id="header-div">
  ...
  <div id="submenu-div">
    <ul>
      <div id="dengrutai"><font id="ECS_MEMBERZONE">
        <?php if(adminche()): ?>您好:<font color="red">
          <b><?php echo (cookie('adminname')); ?></b></font>&nbsp;欢迎登入购物管理系统！
          | <a href="<?php echo U('Admin/admin/logout');?>" target="all-frame">退出</a><?php endif; ?>
      </font>
      </div>
