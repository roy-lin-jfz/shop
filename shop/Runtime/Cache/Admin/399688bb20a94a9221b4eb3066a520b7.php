...
<ul>
  ...
  <li class="explode" key="04_order" name="menu">
    分类管理        <ul>
          <li class="menu-item"><a href="<?php echo U('/admin/cat/catelist');?>" target="main-frame">商品分类</a></li>
          <li class="menu-item"><a href="<?php echo U('/admin/cat/cateadd');?>" target="main-frame">添加分类</a></li>
        </ul>
      </li>
